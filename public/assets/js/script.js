...
document.addEventListener('DOMContentLoaded', function () {
  ...
  (function () {
    ...
    if (ctx) {
        ...
        fetch('/visitors/chart')

            .then(response => response.json())
            .then(data => {
              
                const labels = data.map(item => item.day_name);  // Extract day names
                const visitorCounts = data.map(item => item.visitor_count); // Extract visitor counts
                ...
                var myChart = new Chart(myCanvas, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            ...
                            data: visitorCounts, // Dynamic data
                    ...
                    options: {
                        ...
                        plugins: {
                            ...
                            title: {
                                display: true,
                                text: ['Visitor Statistics', 'Daily Visitors'],
                                align: 'start',
                                color: '#fff',
                                font: {
                                    size: 16,
